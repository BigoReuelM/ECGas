          ...
          <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Overall Total:</div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Php <span id="overall_total"> <?php echo $overall_total;  ?></span></div>
                </div>
                <div class="col-auto">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Php <span id="total_discount"> <?php echo $total_discount;  ?></span></div>
                </div>
                <div class="col-auto">
                  <i class="fas fa-money-bill fa-2x text-gray-300"></i>
                </div>
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Php <span id="total_amount_payable"> <?php echo $total_amount_payable;  ?></span></div>
                </div>
                <div class="col-auto">
                  <i class="fas fa-money-bill fa-2x text-gray-300"></i>
                </div>
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Php <span id="total_amount_paid"> <?php echo $total_amount_paid;  ?></span></div>
                </div>
                <div class="col-auto">
                  <i class="fas fa-money-bill fa-2x text-gray-300"></i>
                </div>
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">Php <span id="total_amount_receivable"> <?php echo $total_amount_receivable;  ?></span></div>
                  </div>
                  <div class="col-auto">
                    <i class="fas fa-money-bill fa-2x text-gray-300"></i>
                  </div>
            ...
            <div class="card-body">
              <form action="<?php echo base_url('pages/getFilteredSales') ?>" id ="sale_filter_form">
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      <label for="sale_status_filter"><small><strong>Sale Status:</strong></small></label>
