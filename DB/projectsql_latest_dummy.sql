...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 04, 2019 at 01:49 PM
...
(3, 'Food', 'Food for me baby', '1000', '2019-03-28', 1),
(4, 'For Transport Of Cylenders', 'This is for the trasport of kwa', '200', '2019-03-28', 1);
...
(8, 6, 1, '2019-03-29 18:17:29', '4700'),
(9, 8, 1, '2019-03-30 11:02:02', '3000'),
(10, 10, 1, '2019-04-04 21:29:08', '1000');
...
(1, 'EC gas', 'Newly delivered brand new cylinders', 2, '2019-03-10 20:09:21', '3000', '2200', 30, 27, 'http://localhost/project/uploads/products/29a594a034a0da784c4d8c64d6337fda.jpg', 'active'),
...
(6, 'Regulator', 'Regulates the flow of gas from the tank to the hose', 1, '2019-03-11 09:40:13', '300', '250', 30, 25, 'http://localhost/project/uploads/products/0b13e74848586d88e45bd840864f7629.jpg', 'active'),
(7, 'Stove', 'Dual burner stove', 1, '2019-03-13 08:07:04', '1200', '1000', 5, 7, 'http://localhost/project/uploads/products/3f50b0360bd1a613d957fccfaa077ecb.jpg', 'active'),
(8, 'Gas stove hose', 'Hose for gas stove', 1, '2019-03-13 08:08:34', '300', '250', 5, 7, 'http://localhost/project/uploads/products/aad5f4fcb0f3f644a84576d6741f2284.jpg', 'active'),
...
(10, 'Hose clamp', 'Clamp for gas hose to prevent leakage', 1, '2019-03-13 08:13:08', '50', '35', 10, 44, 'http://localhost/project/uploads/products/1d3111707c2a3657679b777902f66f32.jpg', 'active'),
...
INSERT INTO `product_return` (`return_id`, `rr_id`, `product_id`, `product_returned_count`) VALUES
(1, 1, 6, 1),
(2, 1, 7, 1),
(3, 1, 8, 1),
(4, 1, 10, 2);
...
INSERT INTO `product_sales` (`product_sales_id`, `product_id`, `sales_id`, `product_count`, `returned_product_count`, `product_total_amount`, `product_cost`, `product_price`) VALUES
(1, 1, 1, 1, 0, '3000', '2200', '3000'),
(2, 1, 2, 1, 0, '3000', '2200', '3000'),
(3, 2, 3, 1, 0, '900', '680', '900'),
(4, 1, 4, 1, 0, '3000', '2200', '3000'),
(5, 1, 5, 1, 0, '3000', '2200', '3000'),
(6, 1, 6, 1, 0, '3000', '2200', '3000'),
(7, 6, 6, 1, 1, '300', '250', '300'),
(8, 7, 6, 1, 1, '1200', '1000', '1200'),
(9, 8, 6, 1, 1, '300', '250', '300'),
(10, 10, 6, 2, 2, '100', '35', '50'),
(11, 1, 7, 1, 0, '3000', '2200', '3000'),
(12, 1, 8, 1, 0, '3000', '2200', '3000'),
(13, 1, 9, 1, 0, '3000', '2200', '3000'),
(14, 1, 10, 1, 0, '3000', '2200', '3000');
...
INSERT INTO `returns_refunds` (`rr_id`, `rr_reason`, `rr_date`, `rr_amount`, `user_id`, `sales_id`) VALUES
(1, 'not needed', '2019-04-04 20:28:24', '850', 1, 6),
(2, 'just refunded', '2019-04-04 20:29:52', '200', 1, 6),
(3, 'just a test', '2019-04-04 21:29:42', '500', 1, 10);
...
INSERT INTO `sales` (`sales_id`, `client_id`, `user_id`, `sales_date`, `sales_total_amount`, `sales_discount`, `sales_total_payable`, `sales_amount_tendered`, `sales_paid_amount`, `sales_balance`, `sales_change`, `sales_refund_amount`, `payment_method_id`, `sales_total_items`, `sales_status`) VALUES
(1, 1, 1, '2019-02-19 12:45:38', '3000', '200', '2800', '3000', '2800', '0', '200', '0', 1, 1, 'fullyPaid'),
(2, 3, 1, '2019-02-20 12:46:11', '3000', '0', '3000', '0', '3000', '0', '0', '0', NULL, 1, 'fullyPaid'),
(3, 7, 1, '2019-03-25 14:29:43', '900', '200', '700', '600', '700', '0', '0', '0', 1, 1, 'fullyPaid'),
(4, 1, 1, '2019-03-25 17:03:59', '3000', '0', '3000', '0', '0', '3000', '0', '0', NULL, 1, 'credit'),
(5, NULL, 1, '2019-03-28 17:08:39', '3000', '0', '3000', '0', '0', '3000', '0', '0', NULL, 1, 'credit'),
(6, 1, 1, '2019-03-29 18:17:29', '4900', '200', '4700', '5000', '4700', '0', '300', '1050', 1, 6, 'fullyPaid'),
(7, 2, 1, '2019-03-29 21:53:12', '3000', '0', '3000', '0', '0', '3000', '0', '0', NULL, 1, 'credit'),
(8, 3, 1, '2019-03-30 11:02:02', '3000', '0', '3000', '3000', '3000', '0', '0', '0', 1, 1, 'fullyPaid'),
(9, 3, 1, '2019-03-30 11:02:43', '3000', '0', '3000', '0', '0', '3000', '0', '0', NULL, 1, 'credit'),
(10, NULL, 1, '2019-04-04 21:29:08', '3000', '300', '2700', '1000', '1000', '1700', '0', '500', NULL, 1, 'partialyPaid');
