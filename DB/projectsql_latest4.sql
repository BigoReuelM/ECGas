...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 13, 2019 at 05:30 AM
...
(1, 'ECGas New Cylinders', 'Newly delivered brand new cylinders', 2, '2019-03-10 20:09:21', '3000', '2200', 30, 30, 'http://localhost/project/uploads/products/29a594a034a0da784c4d8c64d6337fda.jpg', 'active'),
...
(6, 'Regulator', 'Regulates the flow of gas from the tank to the hose', 1, '2019-03-11 09:40:13', '300', '250', 30, 28, 'http://localhost/project/uploads/products/0b13e74848586d88e45bd840864f7629.jpg', 'active'),
...
(2, 6, 1, 1, '300', '250', '300'),
(3, 7, 1, 1, '1200', '1000', '1200'),
(4, 8, 1, 1, '300', '250', '300'),
(5, 10, 1, 2, '100', '35', '50'),
(6, 12, 1, 1, '1500', '1000', '1500');
...
INSERT INTO `sales` (`sales_id`, `client_id`, `user_id`, `sales_date`, `sales_total_amount`, `sales_discount`, `sales_total_payable`, `sales_paid_amount`, `sales_change`, `payment_method_id`, `sales_total_items`) VALUES
(1, 4, 1, '2019-03-13 09:52:04', '6400', '500', '5900', '6000', '100', 1, 7);
